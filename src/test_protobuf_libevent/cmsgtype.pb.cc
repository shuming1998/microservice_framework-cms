...
const char descriptor_table_protodef_cmsgtype_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016cmsgtype.proto\022\004cmsg*Y\n\010CMsgType\022\023\n\017NO"
  "NE_DO_NOT_USE\020\000\022\021\n\rMSG_LOGIN_REQ\020\001\022\021\n\rMS"
  "G_LOGIN_RES\020\002\022\022\n\014MSG_MAX_TYPE\020\377\377\003b\006proto"
  "3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cmsgtype_2eproto = {
  &descriptor_table_cmsgtype_2eproto_initialized, descriptor_table_protodef_cmsgtype_2eproto, "cmsgtype.proto", 121,
