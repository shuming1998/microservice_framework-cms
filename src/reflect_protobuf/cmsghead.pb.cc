...
static void InitDefaultsscc_info_CMsgHead_cmsghead_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_CMsgHead_cmsghead_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_CMsgHead_cmsghead_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_cmsghead_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_cmsghead_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_cmsghead_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_cmsghead_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::cmsg::CMsgHead, msg_str_),
...
const char descriptor_table_protodef_cmsghead_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016cmsghead.proto\022\004cmsg\"\?\n\010CMsgHead\022\020\n\010ms"
  "g_size\030\001 \001(\005\022\017\n\007msg_str\030\002 \001(\t\022\020\n\010msg_typ"
  "e\030\003 \001(\005b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_cmsghead_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_cmsghead_2eproto_sccs[1] = {
  &scc_info_CMsgHead_cmsghead_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_cmsghead_2eproto_once;
static bool descriptor_table_cmsghead_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cmsghead_2eproto = {
  &descriptor_table_cmsghead_2eproto_initialized, descriptor_table_protodef_cmsghead_2eproto, "cmsghead.proto", 95,
  &descriptor_table_cmsghead_2eproto_once, descriptor_table_cmsghead_2eproto_sccs, descriptor_table_cmsghead_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_cmsghead_2eproto::offsets,
  file_level_metadata_cmsghead_2eproto, 1, file_level_enum_descriptors_cmsghead_2eproto, file_level_service_descriptors_cmsghead_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_cmsghead_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_cmsghead_2eproto), true);
namespace cmsg {
...
void CMsgHead::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_CMsgHead_cmsghead_2eproto.base);
  msg_str_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_msg_str(), ptr, ctx, "cmsg.CMsgHead.msg_str");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 msg_type = 3;
...
::PROTOBUF_NAMESPACE_ID::uint8* CMsgHead::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->msg_type() != 0) {
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(3, this->msg_type(), target);
  }
